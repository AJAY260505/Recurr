    ...
    return (
      <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
        <DialogContent>
          ...
          <Summary subscriptions={subscriptions} onClose={onClose} />
        </DialogContent>
      </Dialog>
    );
  }
  ...
  return (
    <Drawer open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DrawerContent>
        ...
        <div className="px-3">
          <Summary subscriptions={subscriptions} onClose={onClose} isDrawer />
        </div>
      </DrawerContent>
    </Drawer>
  );
...
const Summary = ({
  ...
  const { getTransactionsTillDate, removeSubscription } = useSubscriptions();
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-1">
              <Button
                ...
                variant="ghost"
                className="size-8"
                onClick={() => setSubscriptionToEdit(currentSubscription)}
              >
